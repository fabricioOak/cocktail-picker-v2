  ...
  <div v-if="!loading">
      ...
      <div class="grid grid-cols-12 pb-10 sm:px-5 gap-x-8 gap-y-16">
        ...
        >
          ...
          <div class="w-3/4 sm:w-4/12 mt-10">
            <DrinkImage :src="drink.strDrinkThumb" @open-details="getDetails(drink.idDrink)" />
          </div>
          <div
    ...
    <div v-else>
      <div class="h-96 w-screen flex items-center justify-center text-center flex-col">
        ...
        <button
          class="bg-pink-500 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded-full mt-4"
        >
