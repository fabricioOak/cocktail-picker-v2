<template>
  <footer class="text-gray-700 w-full pt-8 bg-white dark:bg-slate-800 bottom-0 body-font z-20">
    <div class="container flex flex-col items-center px-8 py-4 mx-auto max-w-7xl sm:flex-row">
      ...
      <span class="inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start">
        <a
          href="https://www.facebook.com/fabricio.carvalho.52831"
          target="__blank"
        ...
        <a
          href="https://www.instagram.com/fabriciocarvalho_1/"
          target="__blank"
          class="text-pink-400 hover:text-pink-500"
        >
        ...
        <a
          href="https://twitter.com/FabricioOak"
          target="__blank"
          class="text-pink-400 hover:text-pink-500"
        >
